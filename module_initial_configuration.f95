...
module initconfig
	...
	implicit none
		...
		! *******************************************************************************
		!  Particles are shaped like ellipsoids of revolution and thus have only two 
		...
		! *******************************************************************************
		! Unit cell length (Stretched/Narrowed Simple Cube)
		! *******************************************************************************
		!  Makes the unit cell proportional to the molecular geometry.
		!  REMINDER: all length quantities are divided by 'sigma_s'.
		!
		!  Ellypsoid of revolution: Both diameters along x- and y-axis are identical.
		!  Therefore, the unit cell is only stretched/narrowed along z-axis.
		!
		!  For oblate ellipsoids, elongation < 1, so the cubic structure will be narrowed.
		!  For prolate ellipsoids, elongation > 1, so the cubic structure will be stretched.
		!  For spheres, elongation = 1, so the cubic structure will remain unchanged.
		! *******************************************************************************
		coordinate(1) = cell_length			! x-axis (does not change)
		coordinate(2) = cell_length			! y-axis (does not change)
		coordinate(3) = cell_length * elongation	! z-axis (stretching/narrowing)
	...
	subroutine config_bcc()
		...
		! *******************************************************************************
		! Unit cell length (Stretched/Narrowed Body-Centered Cube)
		! *******************************************************************************
		!  Makes the unit cell proportional to the molecular geometry.
		!  REMINDER: all length quantities are divided by 'sigma_s'.
		!
	...
	subroutine config_fcc()
		...
		! *******************************************************************************
		! Unit cell length (Stretched/Narrowed Face-Centered Cube)
		! *******************************************************************************
		!  Makes the unit cell proportional to the molecular geometry.
		!  REMINDER: all length quantities are divided by 'sigma_s'.
		!
	...
	implicit none
		...
		if ( config_selec(1) ) then
			...
			do i = 1, n_particles
				...
				! ***************************************************************
				!  The last three parameters are the ellipsoid radiuses along the 
				!  x-, y-, and z-axes, respectively.
				! ***************************************************************
				write ( 10, * ) atom, r(1,i), r(2,i), r(3,i), q(0,i), q(1,i), q(2,i), q(3,i), &
